...
public class MoveByMouse extends JPopupMenu {
    ...
    MoveByMouse(Main aMain) {
        ...
        JMenuItem mi3 = new JMenuItem("Show Details");
        add(mi3);
        mi3.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
                    Rectangle rect = main.getDisplay().findEventRect(main.gx,main.gy);
                    if (rect != null)
                        main.getDisplay().popUp(rect);
                }
            });
        JMenuItem mi4 = new JMenuItem("Sound Trigger");
        add(mi4);
        mi4.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
                    TimeEvent ev = main.getDisplay().findEvent(main.gx,main.gy);
                    if (ev != null && main.myData.getSoundBank() != null)
                        main.myData.getSoundBank().addEvent(ev);
                }
            });
    }
	...
	// Get coordinates
	CalendarDisplay w = main.getDisplay();
